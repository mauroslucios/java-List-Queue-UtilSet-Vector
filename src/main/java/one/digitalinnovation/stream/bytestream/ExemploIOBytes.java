...
public class ExemploIOBytes {
    ...
    public static void copiarArquivo() throws IOException {
        File f = new File("/home/mauros/IdeaProjects/aulas-digital-innovation/filmes-copy.txt");
...
//      BufferedOutputStream bos = new BufferedOutputStream(os);
        ...
        ps.printf("Arquivo %s copiado com sucesso e esta no diretório %s com %d bytes",
